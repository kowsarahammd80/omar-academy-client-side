...
const UniversityTestAdmissionMap = ({handeleAddtoCart, universityTestData,}) => {
  ...
  const {videolecture, chapterQuantity,videoQuantity,coursPrice,ThecherName,coursThumnil, courseName, _id} =
    universityTestData;
  ...
  return (
    <div className="card card-compact bg-base-100 shadow-xl">
      <figure>
        <img src={coursThumnil} alt="courseImg" className="w-full" />
      </figure>
